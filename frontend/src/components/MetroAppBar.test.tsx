...
describe('metroAppBar renders the app title and logo', () => {
  it(
    'shows the ImageShare title next to the logo',
    () => {
      expect.assertions(2)
      // Arrange + Act
...
describe('metroAppBar shows the user chip with the user name', () => {
  it(
    'displays the authenticated user name',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar falls back to User when name is undefined', () => {
  it(
    'shows the fallback label when the user name is undefined',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar hides the admin button for non-admin users', () => {
  it(
    'does not render an admin button when isAdmin is false',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar shows the admin button for admin users', () => {
  it(
    'renders an admin button when isAdmin is true',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar hides the admin button when isAdmin is undefined', () => {
  it(
    'does not render an admin button when isAdmin is not set',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar renders the breadcrumb slot when provided', () => {
  it(
    'displays breadcrumb content in the centre region',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
...
describe('metroAppBar omits the breadcrumb region when not provided', () => {
  it(
    'does not render a centre region when breadcrumb is undefined',
    () => {
      expect.assertions(1)
      // Arrange + Act
      setupThemeEnvironment(false)
